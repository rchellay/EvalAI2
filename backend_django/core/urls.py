...
urlpatterns = [
    ...
    # Ruta explícita para alumnos de un grupo - usando GroupHierarchyViewSet
    path('grupos/<int:pk>/alumnos/', GroupHierarchyViewSet.as_view({
        'get': 'get_group_students_spanish',
        'post': 'create_student_in_group'
    }), name='group-students'),
